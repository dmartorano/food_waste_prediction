...
Last but not least, once you're happy with you analysis and your model's performance, develop an app with your model. You app can have the summary of your findings in the form of visualizations. It should have a way of taking input from a user and produce output using the trained model, and show the output to the user.

_Goal_: A fully documented repository for technical stakeholders along with a web app.
...
6. A fully functioning web app.
  - You mush have a fully developed web app that is ready to be demoed to your audiance.
  - Greate to have: your app deployed on a free server such as [Render](https://render.com/). But it is not a requirement. Having the app hosted on your local machine will be enough for the demo.
